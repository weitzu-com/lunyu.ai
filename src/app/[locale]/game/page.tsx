...
export const metadata: Metadata = {
  ...
  description: "从少年志学到暮年传道，走过孔子一生的八个阶段。在16个故事情境中作出选择，与孔门弟子同行，读懂《论语》，留下你的学思手记。免费、无需注册，进度在浏览器自动保存。",
